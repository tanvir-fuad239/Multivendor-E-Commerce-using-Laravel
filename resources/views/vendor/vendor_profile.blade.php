                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="{{ empty($vendor_info->photo)? asset('uploads/vendor/avatar.png') : asset('uploads/vendor/images/' . $vendor_info->photo)}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                        <div class="mt-3">
