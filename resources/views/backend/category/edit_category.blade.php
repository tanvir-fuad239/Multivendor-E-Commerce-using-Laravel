                ...
                <div class="card-body p-5">
                    ...
                    <form action="{{ route('category.update',  $category->id) }}" method="post" enctype="multipart/form-data" class="row g-3">
                        ...
                        <div class="col-md-4 mb-2">
                            <img src="{{ empty($category->category_image)? asset("uploads/category/dummy product.png") : asset('uploads/category/images/' . $category->category_image) }}" alt=""  id="selected_photo" height="90px" width="90px">
                        </div>
