                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="header-action-icon-2">
                                       <img src="{{ empty(Auth::user()->photo)? asset("uploads/user/avatar.png") : asset("uploads/user/images/" . Auth::user()->photo) }}" alt="" height="50px" width="50px" class="rounded-circle">
                                    </div>
                                    <span class="lable ml-0 text-primary mt">@ {{ Auth::user()->name }}</span>
