                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="header-action-icon-2">
                                        @php
                                            $role = Auth::user()->role;
                                        @endphp
                                       <img src="{{ empty(Auth::user()->photo)? asset("uploads/user/avatar.png") : asset("uploads/" . $role . "/images/" . Auth::user()->photo) }}" alt="" height="50px" width="50px" class="rounded-circle">
                                    </div>
                                    <span class="lable ml-0 text-primary mt" style="cursor: pointer">@ {{ Auth::user()->name }}</span>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="{{ route('user.password.change') }}"><i class="fi-rs-lock mr-10"></i>Change Password</a>
                                            </li>
                                            <li>
                                ...
                                <div class="header-action-icon-2">
                                    <a href="{{ route('login') }}">
                                        {{-- <img class="svgInject" alt="Nest" src="{{ asset('frontend') }}/assets/imgs/theme/icons/icon-user.svg" /> --}}
                                        <i class="fa fa-sign-in fs-small" aria-hidden="true"></i>
                                    </a>
                                    <a href="{{ route('login') }}"><span class="lable ml-2">Login</span></a>

                                    <span class="lable mx-2 text-primary mt"></span>
